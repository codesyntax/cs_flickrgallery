...
linkcheck_ignore = [
    ...
    r"https://github.com/codesyntax/cs_flickrgallery/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/codesyntax/cs_flickrgallery",
    ...
    "logo": {
        "text": "cs_flickrgallery",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/codesyntax.cs_flickrgallery",
    "repository_branch": "main",
    "repository_url": "https://github.com/codesyntax/cs_flickrgallery",
...
htmlhelp_basename = "cs_flickrgalleryDocumentation"
...
latex_documents = [
    (
        "index",
        "cs_flickrgalleryDocumentation.tex",
        "cs_flickrgallery Documentation",
